...
VALUES (1, 1 , 1, 'Wow! Your recipe is fantastic!'),
  ...
  (4 ,2 , 3, 'Next time I will add more salt.'),
  (5, 1 , 2, 'Never making this recipe again!'),
  ...
  (9, 1 , 1, 'I think I missed an ingredient.'),
  (10, 2 , 3, 'Going to make this for my girlfriend next time.');
